...
\inferrule*[right=Assume$^+$]
  { }
  {\{ \empX \}\ \texttt{assume}(b)\ \{ \empX \wedge b \}}
\]

\\

\textbf{(Allocation and Free)}
...
\textbf{(Structural and Control Rules)}
...
\textbf{(Remaining Inference Rules)}
