...
\begin{minted}{text}
  ...
  -------------------------
\end{minted}
1. Like in the first example the execution starts from $\perp$ meaning that there are no
initial constraints.
...
\begin{minted}{text}
  ...
  Input (default is '1'):
\end{minted}
3. At this point, the user can choose to either view each \textbf{intermediate} step of the loop execution or directly observe the \textbf{final result}. In this example, intermediate steps are omitted in favor of the latter option, in order to reduce clutter and improve clarity and readability. 
